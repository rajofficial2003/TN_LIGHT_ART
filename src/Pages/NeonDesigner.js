...
const colors = [
  ...
  },
  {
    ...
    neon: "rgb(255 255 255) 0px 0px 5px, rgb(255 255 255) 0px0px 10px, rgb(0 255 0) 0px 0px 20px, rgb(0 255 0) 0px 0px 30px, rgb(0 255 0) 0px 0px 40px, rgb(0 255 0) 0px 0px 55px, rgb(0 255 0) 0px 0px 75px",
  },
  {
    name: "Purple",
    color: "rgb(255, 255, 255)",
    ...
    <div className="color-container">
      ...
      <div className="color-grid">
        {colors.map((color, index) => (
          <div key={index} className="color cont" style={{ color: color.iconColor }} onClick={() => setColor(color)}>
...
const NeonDesigner = () => {
  ...
  useEffect(() => {
    updatePrice()
  }, [size, options]) //This line was the target of the update, no changes needed.
    ...
    <div className="">
      ...
      <div className="neonDesigner">
        ...
        <section className="tabs">
          <div className="maxine-title  ">
            <MainTitle>Custom NeonZ <span className="d-lg-none" >Design your slang!</span></MainTitle>
          </div>
          <div className="text-center d-none d-lg-block ">
            <MainTitle>Design your slang!</MainTitle>
          </div>
